 ...
 *   src/components/account/order-qr-dialog.tsx (OrderQrFlow)
 *
...
import { OrderQrFlow } from "@/components/account/order-qr-dialog";
import type { Plan } from "@/lib/account/user-types";
