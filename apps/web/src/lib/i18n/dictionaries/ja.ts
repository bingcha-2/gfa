...
export const ja: DeepPartialDict = {
  ...
  portalApp: {
    ...
    billing: {
      ...
      durationDays: "{n} 日",
      buyNow: "今すぐ購入",
      bindSection: "カードをバインド",
      bindDesc: "旧版カードをお持ちですか?アカウントにバインドすると即時有効になります。",
      cardKeyLabel: "カード",
      cardKeyPlaceholder: "カードキーを入力(例: AI…)",
      bindSubmit: "カードをバインド",
      binding: "バインド中…",
      bindSuccessTitle: "バインド完了",
      bindSuccessToast: "カードをバインドし、サブスクリプションを有効化しました",
      bindAlreadyBound: "このカードはすでに現在のアカウントにバインドされています。詳細は以下のとおりです。",
      bindErrors: {
        CARD_NOT_FOUND: "カードが見つかりません。入力内容をご確認ください。",
        CARD_DISABLED: "このカードは無効化されています。サポートにお問い合わせください。",
        CARD_EXPIRED: "このカードは期限切れのためバインドできません。",
        CARD_ALREADY_BOUND: "このカードはすでに別のアカウントにバインドされています。",
        fallback: "バインドに失敗しました。しばらくしてからもう一度お試しください。",
      },
      ordersSection: "注文履歴",
