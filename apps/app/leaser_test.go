...
// TestActivateSuccessClearsCardUnusable was removed with the card-activation
// API (Activate): the account-login session flow replaced card activation, and
// lease success (above) now owns the cardUnusable recovery path.
