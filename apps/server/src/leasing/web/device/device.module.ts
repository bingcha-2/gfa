 ...
 *   - GET   /api/web/devices            list devices + effective device limit
 *   - PATCH /api/web/devices/:id        rename a device
 *   - POST  /api/web/devices/:id/revoke revoke a device (REVOKED + sessionJti=null)
 *
