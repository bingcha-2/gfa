...
const partial = await p.$queryRaw`
  ...
  FROM Task WHERE id = ${'cmniuxg07001'}
`;
...
writeFileSync('tmp_task_cmniuxg07001_out.json', JSON.stringify(out, null, 2), 'utf8');
console.log('Written to tmp_task_cmniuxg07001_out.json');
